      ...
      <Content style={{ padding: '20px', marginTop: '64px' }}>
        ...
        <div style={{ 
          ...
          <Paragraph style={{ 
            ...
            Multiversal.blog was born from a simple belief: every human has a story worth telling,            and every story deserves an audience that truly listens. We&apos;re not just a platform –
            ...
            {awards.map((award, index) => (
              <Col xs={12} md={6} key={index}>
                <Card size="small" style={{ 
                  ...
                  <Trophy className="w-8 h-8" style={{ color: '#faad14', marginBottom: '12px' }} />
        ...
        <div style={{ 
          ...
          <Space size="large">
            <Button type="primary" size="large" icon={<Edit3 className="w-4 h-4" />}>
              Start Creating
            </Button>
