...
export default function Community() {
  ...
  const communityStats = [
    { title: 'Active Members', value: 12847, icon: <TeamOutlined />, color: '#1890ff' },
    { title: 'Daily Posts', value: 342, icon: <FireOutlined />, color: '#ff4d4f' },
    { title: 'Stories Shared', value: 8921, icon: <BookOutlined />, color: '#52c41a' },
    { title: 'Connections Made', value: 15673, icon: <HeartOutlined />, color: '#fa8c16' },
  ];
    ...
    <Layout style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
      ...
      <Content style={{ padding: '20px', marginTop: '64px' }}>
        ...
        <div style={{ 
          ...
          <Button type="primary" size="large" icon={<UserAddOutlined />} style={{ marginRight: '16px' }}>
            Join Community
          </Button>
        ...
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24} lg={8}>
            ...
            >
              <Space direction="vertical" style={{ width: '100%' }}>
                <Button type="primary" block size="large" icon={<MessageOutlined />}>
                  Start a Discussion
                </Button>
                ...
                <Button block size="large" icon={<ShareAltOutlined />}>
                  Share Your Work
                </Button>
              </Space>
            </Card>
