...
const MenuBar = ({ editor }) => {
    ...
    return (
        <div className="poetry-editor-menu rounded-t-lg border-b border-gray-100 p-3 bg-white flex flex-wrap gap-1 items-center">
            <div className="mr-2 flex items-center">
                <Feather className="w-4 h-4 mr-1 text-purple-500" />
                <span className="text-xs font-medium text-gray-500">Poetry</span>
            </div>
...
const PoetryEditor = ({ content = '', onChange, placeholder = 'Start writing your poem here...' }) => {
    ...
    return (
        <div className="poetry-editor border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        ...
        .poetry-editor .ProseMirror p {
          margin: 0.5em 0;
        }
        .poetry-editor .ProseMirror blockquote {
        ...
        .poetry-editor .ProseMirror.is-editor-empty:first-child::before {
